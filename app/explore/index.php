        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item active">
              <a class="nav-link" href="http://18.221.151.169" style="color:#ffffff;">Home</a>
            </li>
            <li class="nav-item">
	      <a class="nav-link" href="http://mittuanand.com" style="color:#ffffff;">Author</a>
            </li>
...
?>
<div class="col-lg-12 col-lg-offset-22" id="content-placeholder" style="margin-top:20px;padding:50px;">
<div class="row">
<div class="col-sm-6">
...
<div class="col-sm-6">
  ...
  <script>
    ...
    $("#countrylist").click(function(){
     ...
     $.ajax({
     url: "http://18.221.151.169:8081/index.php",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        type: "POST",
        data: '{ID:"00123"}',
      ...
      $("#culturelist").click(function(){
     $.ajax({
     url: "http://18.221.151.169:8082/index.php",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        type: "POST",
        data: '{ID:"00123"}',
